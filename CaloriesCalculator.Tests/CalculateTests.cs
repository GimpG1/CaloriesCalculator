...
public class CalculateTests
{
    ...
    public void Check_IfCanCalculate_BaseMetabolism(SexOrientation orientation, float ppm, float weight, float height, uint age)
    {        
    ...
    public void Check_IfCanCalculate_TotalMetabolism(SexOrientation orientation, Protos.ActivityLevel activity, float cpm, float ppm, float weight, float height, uint age)
    {          
        var helper = new HelperCalculationsTests();
        var _mActivity = new Mock<IActivity>();
